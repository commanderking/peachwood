...
const images2025: YearlyData = {
  ...
  introComments: [
    ...
    },
    {
      ...
      CH: "好喔，我也來了。 不要忘記我們是雙語動物，可以選擇英文或者中文。",
    },
  ],
  images: [
    {
      ...
      comments: [
        {
          ...
          CH: "今年剛開始跟其他幾年差不多。 雖然我今年十歲了， 但是我跟我以前看起來一模一樣。",
        },
        {
          commentator: "WOODY",
          avatarImage: "woody_excited.png",
          ...
          CH: "對啊， 妳一向就是那樣子。 為什麼 Allison 手機的背景一向是妳呢？",
        },
        {
          commentator: "PEACH",
          avatarImage: "peach_hungry.png",
      ...
      comments: [
        {
          ...
          CH: "看一下喔， Jimmy 跟 Allison 去了日本渡蜜月。他們一直在想我們， 把這幅全家福帶回來了。",
        },
        {
          commentator: "WOODY",
          avatarImage: "woody_uncomfy.jpg",
      ...
      comments: [
        {
          ...
          CH: "喔，今年發生的一件很大的事情就是 Allison 的書終於出版了。",
        },
        {
          commentator: "WOODY",
          avatarImage: "woody_excited.png",
      ...
      comments: [
        {
          ...
          CH: "Jimmy 真的很同情我。為了團結， 他也去得到了一個很大的青腫。",
        },
        {
          commentator: "WOODY",
          avatarImage: "woody_sad.jpg",
